...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter implements WebMvcConfigurer {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.httpBasic().disable()
                ...
                .antMatchers(HttpMethod.DELETE, "/balance/id/{id}").hasRole("ADMIN")
                .antMatchers(HttpMethod.DELETE, "/articles/id/{id}").hasAnyRole("USER","ADMIN")
                ...
                .antMatchers(HttpMethod.PUT, "/articles/id/{id}").hasAnyRole("USER", "ADMIN")
